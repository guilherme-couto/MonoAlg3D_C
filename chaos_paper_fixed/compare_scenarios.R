...
SCENARIOS <- list(
  "Scenario I" = "./2D/full/post_processing_complete/data_for_gam_r.csv",
  "Scenario II" = "./2D/ellipse/post_processing_complete/data_for_gam_r.csv",
  "Scenario III" = "./3D/full/post_processing_complete/data_for_gam_r.csv"
)
...
REF_SCENARIO <- "Scenario I" # Must match one of the scenario names
...
# Output settings
OUTPUT_DIR <- "scenario_comparison_outputs/2Dfull_vs_2Dellipse_vs_3Dfull"
...
p_forest <- ggplot(or_df, aes(x = OR, y = fibrosis_type, color = Scenario)) +
  ...
  theme(axis.text.x = element_text(size = 14, color = "black", face="bold"),
        ...
        axis.title.x = element_text(size = 16), legend.position = "top", legend.justification = "left", legend.title = element_blank(),
...
p_bar <- ggplot(incidence_df, aes(x = fibrosis_type, y = total_success, fill = Scenario)) +
  ...
  labs(title = "Overall Arrhythmia Incidence Across Scenarios", x = "", y = "Total Number of Sustained Reentries") +
  theme_minimal(base_family = "sans", base_size = 16) +
  theme(axis.text.x = element_text(size = 14, color = "black", face="bold"),
        axis.text.y = element_text(size = 14, color = "black", face = "bold"),
        axis.title.y = element_text(size = 16), legend.position = "top", legend.justification = "left", legend.title = element_blank(),
